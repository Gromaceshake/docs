...
description: 'John Development allows an intergation, installing it will allow you to change settings within your application.client service.'
icon: 'gear'
---
...
<ResponseField name="topbarLinks" type="TopbarLink[]">
  ...
  <Expandable title="TopbarLink">
    ...
    The url once you click on the button. Example: `https://johndevelopment.xyz/contact`
    </ResponseField>
...
<ResponseField name="footerSocials" type="FooterSocials">
  ...
  ```json
  {
    "website": "https://johndevelopment.xyz"
  }
  ```
